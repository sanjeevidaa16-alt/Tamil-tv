    ...
    <div id="login-page" className="min-h-[85vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-[#11131d] border border-slate-800 rounded-3xl p-8 shadow-2xl relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-semibold text-slate-200 mt-1">Welcome Back</p>
          <p className="text-xs text-slate-400 mt-0.5">Sign in to your StreamVault account</p>
        </div>
